...
# ✅ Load model and feature order from saved file
...
city_map = {'Islamabad': 0, 'Lahore': 1, 'Karachi': 2, 'Peshawar': 3, 'Quetta': 4}  # Extend if needed
location_map = {'G-10': 0, 'E-11': 1, 'G-15': 2, 'Bani Gala': 3, 'DHA Valley': 4}  # Extend if needed
